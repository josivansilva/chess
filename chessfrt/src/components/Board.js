...
class Board extends React.Component {
    ...
    handleClick(i) {
      ...
      this.changeSelectedCellColor(i);
    }

    changeSelectedCellColor(id) {
      this.changeCellDefaultColor();
      setTimeout(function() {
          document.getElementById(id).style.backgroundColor = "#eaa000";
      }, 50);            
    }
    ...
    changeMovesBackgroundColor () {
      for (let i = 0; i < this.state.positions.length; i++) {
          let id = this.state.positions[i];
